...
object PreferencesHelper {
    ...
    fun setFirstStart(isFirst: Boolean) = PreferencesUtil.saveValue(PreferencesKey.IS_FIRST, isFirst)
    ...
    fun getPPrivate(): String = PreferencesUtil.getString(PreferencesKey.PPRIVATE,"https://privacy.loanbeer.com")
    ...
    fun setShowFeiled(isShow: Boolean) = PreferencesUtil.saveValue(PreferencesKey.ISSHOWFEILED, isShow)
