package com.ronal.camera.camera;
...
import com.ronal.camera.utils.CommonUtils;
import com.ronal.camera.utils.FileUtils;
import com.ronal.camera.utils.ImageUtils;
    ...
    private void initView() {
        ...
        switch (mType) {
            ...
            case IDCardCamera.TYPE_IDCARD_BACK:
                ...
                break;
            default:
                mIvCameraCrop.setImageResource(R.mipmap.camera_empty);
                break;
        }
